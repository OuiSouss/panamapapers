...
dict_type ={
    'unknown':[''],
    'first vice president and director':['1st v.p. / director'],
    'second vice president':['2nd vice president','second vice president'],
    'third vice president':['3rd vice president'],
    ...
    'first beneficiary of':['first beneficiary of'],
    'first director':['first director'],
